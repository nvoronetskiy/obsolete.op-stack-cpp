...
#op-stack-cpp module build
echo "------ Building op-stack-cpp for ANDROID platform -------"
pushd `pwd`
mkdir -p ./../../../build/android/op-stack-cpp
...
echo "-------- Installing op-stack-cpp libs -----"
cp -r ./obj/local/armeabi/lib* ./../../../build/android/op-stack-cpp/
